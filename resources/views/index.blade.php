...
<html>
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="{{ asset('vendor/healthcare/css/animate.css') }}">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="{{ asset('vendor/healthcare/css/icomoon.css') }}">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="{{ asset('vendor/healthcare/css/bootstrap.css') }}">
	<!-- Magnific Popup -->
	<link rel="stylesheet" href="{{ asset('vendor/healthcare/css/magnific-popup.css') }}">
	<!-- Owl Carousel  -->
	<link rel="stylesheet" href="{{ asset('vendor/healthcare/css/owl.carousel.min.css') }}">
	<link rel="stylesheet" href="{{ asset('vendor/healthcare/css/owl.theme.default.min.css') }}">
	<!-- Flexslider  -->
	<link rel="stylesheet" href="{{ asset('vendor/healthcare/css/flexslider.css') }}">
	<!-- Flaticons  -->
	<link rel="stylesheet" href="{{ asset('vendor/healthcare/fonts/flaticon/font/flaticon.css') }}">
	<!-- Theme style  -->
	<link rel="stylesheet" href="{{ asset('vendor/healthcare/css/style.css') }}">

	<!-- Modernizr JS -->
	<script src="{{ asset('vendor/healthcare/js/modernizr-2.6.2.min.js') }}"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
