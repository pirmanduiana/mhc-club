...
class InvWarehousesController extends Controller
{
    ...
    {
        $grid = new Grid(new InvWarehouses);
    ...
    {
        $show = new Show(InvWarehouses::findOrFail($id));
    ...
    {
        $form = new Form(new InvWarehouses);
